...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    projectile = sprites.createProjectileFromSprite(img`
        ...
        . . . . . b b b b b b . . . . . 
        `, mySprite, 100, 0)
    projectile.setKind(SpriteKind.bubble)
    projectile.startEffect(effects.bubbles)
})
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.bubble, function (sprite, otherSprite) {
    sprite.destroy()
})
...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
game.showLongText("The humans have stolen the ducks eggs get to the ducks eggs before the humans eat them", DialogLayout.Bottom)
